...
const dados = { nome: 'Ana Souza', motorista: { id: '1', nome: 'Carlos' }, veiculo: 'Toyota · Corolla · Preto', placa: 'ABC1D23', origem: 'Aeroporto de Guarulhos (GRU), Terminal 3', destino: 'Av. Paulista, 1578 - Bela Vista, São Paulo', previsao: new Date(Date.now()+8*60e3).toISOString(), origemCoord: { lat: -23.4356, lon: -46.4731 }, destinoCoord: { lat: -23.5613, lon: -46.6565 }, link: 'https://tr.ac.cab/NzAwMDAyMg:342bngw_Wk6k7-nKegSLtg' }
